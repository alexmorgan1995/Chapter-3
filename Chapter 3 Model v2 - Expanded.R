...
parms = c(betaUKaa = 0.1, betaNEDaa = 0.1, betaPOLaa = 0.1,  betaIREaa = 0.1,
          ...
          betaUKha = 0.1, betaNEDha = 0.1, betaPOLha = 0.1, betaIREha = 0.1, betaBELha = 0.1, betaGERha = 0.1, betaITAha = 0.1, 
          betaFRAha = 0.1, betaSPAha = 0.1, betaROMha = 0.1, betaTHAha = 0.1, betaBRAha = 0.1, betaCHIha = 0.1, 
          
          tauUK = 0.05, tauNED = 0.08, tauPOL = 0.1, tauIRE = 0.1, tauBEL = 0.05, tauGER = 0.08, tauITA = 0.1, tauFRA = 0.1, 
...
outdata$UKIComb <- outdata$UKhs + outdata$UKhr 
