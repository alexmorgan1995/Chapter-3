...
ABC_algorithm <- function(N, G, distanceABC, fitmodel, tau_range, init.state, data, epsilon, lm.low, lm.upp, thetaparm)  {
  ...
  for(g in 1:G) {
    ...
    write.csv(res.old, file = paste("C:/Users/amorg/Documents/PhD/Chapter_3/Models/Chapter-3/Model_Fit_Data/Part1/ABC_post_amppigs_gen_",g,".csv",sep=""), row.names=FALSE)
    }
  return(out)
}
...
saveRDS(test, file = "C:/Users/amorg/Documents/PhD/Chapter_3/Models/Chapter-3/Model_Fit_Data/Part1/dist_amppig_part1_list.rds")
...
post_dist_names <- grep("ABC_post_amppigs_gen_",
