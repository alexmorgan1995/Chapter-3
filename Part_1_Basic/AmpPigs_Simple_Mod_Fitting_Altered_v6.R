...
ABC_algorithm <- function(N, G, distanceABC, fitmodel, tau_range, init.state, data, epsilon, lm.low, lm.upp, thetaparm)  {
  ...
  for(g in 1:G) {
    ...
    write.csv(res.old, file = paste("/localdisk/home/s1678248/Parallel_Testing/Chapter_3/Output/ABC_post_amppigs_genv2_",g,".csv",sep=""), row.names=FALSE)
    }
  return(out)
}
...
saveRDS(test, file = "/localdisk/home/s1678248/Parallel_Testing/Chapter_3/Output/dist_amppig_part1_list.rds")
