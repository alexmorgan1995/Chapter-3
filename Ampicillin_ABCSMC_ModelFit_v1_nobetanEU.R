  ...
  for(g in 1:G) {
    ...
    while(i <= N) {
      ...
      if(g==1) {
        ...
        d_phi <- runif(1, min = 0, max = 50)
        d_kappa <- runif(1, min = 0, max = 1500)
        d_alpha <- rbeta(1, 1.5, 8.5)
        d_zeta <- runif(1, 0, 0.0045)
        
        d_betaHD <- runif(1, 0, 0.0045)
        d_betaHH <- runif(1, 0, 0.2)
        d_betaHI_EU <- runif(1, 0, 0.00045)
...
lm.upp <- c(1, 50, 1500, 1, 0.0045, 0.0045, 0.2, 0.00045, 1, 1)
...
epsilon_dist <-  c(2, 1.75, 1.5, 1.25, 1, 0.9, 0.85, 0.825, 0.8, 0.75)
epsilon_foodH <- c(3.26, 3.26*0.75, 3.26*0.6, 3.26*0.5, 3.26*0.4, 3.26*0.3, 3.26*0.2, 3.26*0.15, 3.26*0.1, 3.26*0.05)
epsilon_AMRH <-  c(0.185, 0.185*0.75, 0.185*0.6, 0.185*0.5, 0.185*0.4, 0.185*0.3, 0.185*0.2, 0.185*0.15, 0.185*0.1, 0.185*0.05)
epsilon_foodA <- c(0.017173052, 0.017173052*0.75, 0.017173052*0.6, 0.017173052*0.5, 0.017173052*0.4, 0.017173052*0.3, 0.017173052*0.2, 0.017173052*0.15, 0.017173052*0.1, 0.017173052*0.05)
epsilon_AMRA <-  c(0.3333333, 0.3333333*0.75, 0.3333333*0.6, 0.3333333*0.5, 0.3333333*0.4, 0.3333333*0.3, 0.3333333*0.2, 0.3333333*0.15, 0.3333333*0.1, 0.3333333*0.05)
