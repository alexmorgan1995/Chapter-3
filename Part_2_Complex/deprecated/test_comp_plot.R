...
#New Import Parms 
thetaparm = c(ra = 60^-1, rh = (5.5^-1), ua = 240^-1, uh = 28835^-1, psi = 0,
...
ggplot(usage_frame, aes(x = domusage, y = relchange)) + geom_line() + scale_x_continuous(limits = c(0, 0.656)) +
