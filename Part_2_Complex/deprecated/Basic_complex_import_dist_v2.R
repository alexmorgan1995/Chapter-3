...
base_homo_fracimp <- data.frame(matrix(rbeta(100*10, shape1 =  1, shape2 =  1), 
                  nrow = 100, ncol = 10))
...
base_skew_fracimp <- data.frame(matrix(rbeta(100*10, shape1 =  1, shape2 =  3), 
                                  nrow = 100, ncol = 10))
...
explore_parms <- list(homo_import, skew_import)
