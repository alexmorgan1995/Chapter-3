...
rm(list=ls())
setwd("/localdisk/home/s1678248/Parallel_Testing/Chapter_3/Data/part2")
...
ABC_algorithm <- function(N, G, distanceABC, fitmodel, tau_range, init.state, data, epsilon, lm.low, lm.upp, thetaparm)  {
  ...
  for(g in 1:G) {
    ...
    write.csv(res.old, file =  paste("/localdisk/home/s1678248/Parallel_Testing/Chapter_3/Output/part2/ABC_post_complex_v3_amppigs_",g,".csv",sep=""), row.names=FALSE)
  }
  return(out)
}
...
test <- ABC_algorithm(N = 1000,
                      ...
                      init.state = c(Sa=0.98, Isa=0.01, Ira=0.01, 
                                     ...
                                     IshAnEU = 0,IrhAnEU = 0), 
                      data = melt_amp_pigs, 
                      epsilon = list("dist" =  c(5, 4, 3.75, 3.5, 3.25, 3, 2.75, 2.5),
                      ...
                      lm.upp = c(0.05, 0.025, 20, 1, 0.02, 0.01, 0.3, 1), 
...
saveRDS(test, file = "/localdisk/home/s1678248/Parallel_Testing/Chapter_3/Output/part2/chapter_part2_v3.RDS")
